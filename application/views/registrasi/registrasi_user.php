            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="<?php echo base_url('index.php/Cregistrasi/simpan_registrasi_user') ?>" method="post">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="NPM" name="npm" type="text" value="">
                                </div>
